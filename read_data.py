...
class MyData(Dataset):
    ...
    def __init__(self, root_dir, image_dir, label_dir, transform):
        ...
        self.label_path = os.path.join(self.root_dir, self.label_dir) # 字符串拼接
        self.image_path = os.path.join(self.root_dir, self.image_dir)
        self.image_list = os.listdir(self.image_path) # 获取文件夹下的所有文件名，返回一个列表
...
if __name__ == '__main__':
    ...
    root_dir = "..\\dataset\\practice_data\\train"
